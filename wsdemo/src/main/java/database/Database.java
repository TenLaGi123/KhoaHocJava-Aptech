...
public class Database implements IUserModel{
    ...
    @Override
    public User login(String name, String email, String password, String userType) throws Exception {
        User user = null;
        String sqlCommand = "";
        try {
            ...
            throw new Exception(String.format("Cannot login user.Error: %s", e.toString()));
